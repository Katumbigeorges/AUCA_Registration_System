<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.auca.domain.Equalification" %>
...
<title>Teacher - Adventist University Of central Africa</title>
...
<section class="main">
    ...
    <select id="qualification" name="qualification">
        <c:forEach var="qualificationType" items="${Equalification.values()}">
