...
<title>AcademicUnit - Adventist University Of central Africa</title>
    ...
    <select id="qualification" name="type">
        <c:forEach var="academicUnitType" items="${Eacademicunit.values()}">
			...
			<div class="form-group password">
              ...
              <input type="text" id="name" placeholder="Enter the parent code" name="parent">
            </div>
            <br />
