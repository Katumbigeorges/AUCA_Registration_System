...
<title>Semester - Adventist University Of central Africa</title>
...
<section class="main">
        ...
        <form action="semester" method="post">
            ...
            <div class="form-group email">
              ...
              <input type="date" id="code" placeholder="Enter Start Date" name="start">
            </div>
            <div class="form-group password">
              <label for="email">End Date</label>
              <input type="date" id="name" placeholder="Enter End Date" name="end">
            </div>            
            <br />
