...
<title>Course - Adventist University Of Central Africa</title>
...
<section class="main">
        ...
        <form action="course" method="post">
            ...
            <div class="form-group password">
              <label for="password">Teacher Code</label>
              <input type="text" id="name" placeholder="Enter Teacher Code" name="teachercode">
            </div>
              <div class="form-group password">
              <label for="password">Semester Code</label>
              <input type="text" id="name" placeholder="Enter Semester Code" name="semestercode">
            </div>
            <div class="form-group password">
              <label for="password">Academicunit Code</label>
              <input type="text" id="name" placeholder="Enter Academicunit Code" name="academicunitcode">
            </div>
            <br />
